...
class HomeAutoPilot(object):
    def __init__(self, input_size = 9, hidden_size = 128, num_lstm_layers = 2, num_classes = 2, num_devices = 213):
        self.logger = logging.getLogger(__name__)
        logging.basicConfig(level=logging.INFO)
        self.model = MultiTaskLSTM(input_size=input_size, num_lstm_layers=num_lstm_layers, hidden_size=hidden_size, num_classes=num_classes, num_devices=num_devices)
