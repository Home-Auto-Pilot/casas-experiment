...
def prep_tensors(data_files, input_tr_path = 'input_seq_tensors.pt', dev_tr_path = 'act_dev_tensors.pt', state_tr_path = 'act_state_tensors.pt', timing_tr_path = 'act_timing_tensors.pt'):
    ...
    return (input_tensors, act_dev_tensors, act_state_tensors, act_timing_tensors, n_features, n_act_state, n_act_dev)